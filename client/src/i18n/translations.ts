...
export const de = {
  ...
  "controls.documentPointsPerSecondUnit": "Punkte/Sek.",
  "controls.documentPointsPerSong": "Dokumentpunkte pro Song",
  "controls.documentSpeedHint": "Die Geschwindigkeit ist für alle Geräte identisch und unabhängig von der Ansicht.",
...
export const en: Record<TKey, string> = {
  ...
  "controls.screensPerMinuteUnit": "screens/min",
  "controls.screensPerMinuteShort": "spm",
  "controls.documentPointsPerSecondUnit": "points/sec",
  "controls.documentPointsPerSong": "Document points per song",
  "controls.documentSpeedHint": "This speed is identical on every device and independent of the viewport.",
