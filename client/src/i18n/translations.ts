...
export const de = {
  ...
  "controls.shortcutsHint": "Leertaste = Play/Pause, ←/→ = Seite, ↑/↓ = Geschwindigkeit, 0 = Anfang, S = Marker",
...
export const en: Record<TKey, string> = {
  ...
  "controls.shortcutsHint": "Space = Play/Pause, ←/→ = page, ↑/↓ = speed, 0 = start, S = marker",
